...
* [EE Bean validation](java/ee-bean-validation.md)
* [EE CDI](java/ee-cdi.md)
* [EE EJB](java/ee-ejb.md)
* [EE JARS](java/ee-jaxrs.md)
* [EE JNDI](java/ee-jndi.md)
* [EE transactions](java/ee-transactions.md)
...
* [Book review: GO Programming blueprints](../books/go-programming-blueprints.md)
